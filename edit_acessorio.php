...
$sql = "SELECT * FROM acessorio WHERE id_acessorio=$id_acessorio";
        ...
        <form action="processa_acessorio.php" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-xl-6 pb-2">
                    <input type="hidden" name="id_acessorio" value="<?php echo $dados['id_acessorio']?>">
            ...
            <div class="row">
                <div class="col-xl-12 pb-2">
                    ...
                    <textarea class="form-control" name="descricao" id="texto" cols="100" rows="30" required><?php echo $dados['descricao']?></textarea>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-12 pb-2">
